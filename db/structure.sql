...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_test_email CHECK (((email)::text ~* '^[^@]+@test\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20160904195916');

INSERT INTO schema_migrations (version) VALUES ('20160906024150');

INSERT INTO schema_migrations (version) VALUES ('20160906133301');

INSERT INTO schema_migrations (version) VALUES ('20160906173836');

INSERT INTO schema_migrations (version) VALUES ('20160907201509');
